    ...
    <div id="block" class="container" style="padding: 0.8rem;">
        <div class="container" style="text-align: center;">
            ...
            <p style="background-color: aqua;">
                ...
                $result = mysqli_query($link, 'SELECT * FROM dean,department WHERE dean.department_code=department.department_code AND department.department_name="Students"');
        ...
        <table class="table table-bordered  text-center " style="margin:auto; margin-bottom: 20px;">
            ...
            <tbody>
                ...
                /*Create query*/
                $qry = 'SELECT * FROM dean_info WHERE department_name="Students"';
