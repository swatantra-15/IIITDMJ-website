...
<body>
    <div class="navbar" style="background-image: linear-gradient(rgba(0,5,30,0.7),rgba(0,5,30,0.7)),url(stylesheets/images/College2.jpg)">
    <?php include 'topnav.php'; ?>
    <?php include 'mainnav.php'; ?>
    <div class="about">
        <h1>About IIITDM Jabalpur </h1>
    </div>
</div>
<div class="features">
    <h2>ABOUT</h2>
