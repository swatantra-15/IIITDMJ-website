...
<body>
    <div class="navbar" style="background-image: linear-gradient(rgba(0,5,0,0.7),rgba(0,5,30,0.7)),url(stylesheets/images/Badminton.jpeg)">
    ...
    <div class="features">
        <section class="featurescontent">
            <section class="child" style="min-width: 70%;">
                <table>
                    <tr>
                        ...
                        <td>
                            ...
                            <div class="aboutcontent">
                                <img src="stylesheets/images/activity1.jpg" style="width:100%">
                            </div>
                            <div class="aboutcontent">
                                <a href="downloads/IHPC_report_2017.pdf">Report on the major activities and events conducted by the Indian Heritage and Philosophy Club in the session 2016-17</a>
                            </div>
                            <hr>
                            <div class="aboutcontent">
                ...
                <br>
                <h2 align="center">Some Videos</h2>
